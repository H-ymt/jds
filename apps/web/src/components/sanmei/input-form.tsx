...
export function InputForm({ birthDate, gender, isLoading, onBirthDateChange, onGenderChange, onSubmit }: InputFormProps) {
  return (
              ...
              {(["female", "male"] as const).map((g) => (
                <button
                  ...
                  className={cn(
                    ...
                    gender === g ? "bg-primary text-primary-foreground shadow-md" : "bg-muted hover:bg-muted/80 text-muted-foreground"
                  )}
                >
